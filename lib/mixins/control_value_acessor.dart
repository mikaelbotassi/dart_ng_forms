...
mixin ControlValueAcessor<T> on Widget {
  ...
  */
  ...
  bool get touched {
    assert(() {
      if (control == null && (formGroup == null || name == null)) {
        throw FlutterError('ControlValueAcessor: model or formGroup and name must be provided to verify if value is touched');
      }
      return true;
    }());
    if (formGroup != null && name != null) {
      return formGroup!.control(name!).touched;
    }
